...
for line in file:
	...
	m_iter = re.finditer('[aeiouāīū@RL\%EO][^aeiouāīū@RL\%EO\s]*[aeiouāīū@RL\%EO][^aeiouāīū@RL\%EO\s]*\s' , line)
	for m in m_iter:
		m.group()
		rhymepattern.append(m.group())
	n = re.search('[aeiouāīū@RL\%EO][^aeiouāīū@RL\%EO\s]*[aeiouāīū@RL\%EO][^aeiouāīū@RL\%EO\s]*$' , line)
	if n:
