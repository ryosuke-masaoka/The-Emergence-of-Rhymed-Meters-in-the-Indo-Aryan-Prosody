...
for line in file:
	...
	if '/' in line:
		...
		line = re.sub('_', '', line)
		m_iter = re.finditer('[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*\s' , line)
		for m in m_iter:
			m.group()
			rhymepattern.append(m.group())
		n = re.search('[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*\/$' , line)
		if n:
			odd = n.group()
			odd = re.sub('\/', '', odd)
		o = re.search('[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*\/\s' , line)
		if o:
			odd = o.group()
			odd = re.sub('\/', '', odd)
			odd = re.sub('\s', '', odd)
		p = re.search('[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*[aeiouāãĕīïĩŏũüūōēẽUAEOR][^aeiouāãĕīïĩŏũüūōēẽUAEOR\s]*\/\/' , line)
		if p:
			even = p.group()
			even = re.sub('\/', '', even)
			if even == odd:
